    ...
    @Override
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            java.util.logging.Logger.getLogger(CustomerSearch.class.getName()).log(Level.SEVERE,null,ex);
        }
        ...
        try{
            ...
            if(searchType.equals("name")){
             ...
             session.setAttribute("productList", productList); //Successfully updated
            request.getRequestDispatcher("CustomerProductSearch.jsp").include(request, response);
        }  catch (SQLException ex) {
