 ...
 * @author Mushini
 */
@WebServlet(name = "RegisterIotBay", urlPatterns = {"/RegisterIotBay"})
public class RegisterIotBay extends HttpServlet {
    ...
    manager.addCustomer(firstName, middleName,lastName,email,mobileNumber,address,state,city,postcode,password);
