 ...
 * @author brend
 */
@WebServlet(name = "GuestCustomerSearch", urlPatterns = {"/GuestCustomerSearch"})
public class GuestCustomerSearch extends HttpServlet {
    ...
    @Override
     protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            java.util.logging.Logger.getLogger(GuestCustomerSearch.class.getName()).log(Level.SEVERE,null,ex);
        }
        ...
        try{
            ...
            if(searchType.equals("name")){
             ...
             session.setAttribute("productList", productList); //Successfully updated
            request.getRequestDispatcher("GuestCustomerSearch.jsp").include(request, response);
        }  catch (SQLException ex) {
