...
public class staffUpdate extends HttpServlet {
    ...
    if(firstName != null){
        ...
        manager.updateStaff(firstName, middleName,lastName,email,mobileNumber,address,state,city,postcode,password);
        //get the new details by getting the customer object instance blah blah lol
        customerDetails = manager.findStaff(email, password);
